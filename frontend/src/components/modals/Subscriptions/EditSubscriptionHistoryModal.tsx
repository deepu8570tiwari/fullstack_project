...
interface EditClientModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (client: HistoryEdit) => void;
  edithistory: HistoryEdit;
}

function EditSubscriptionHistoryModal({ isOpen, onClose, onSave, edithistory }: EditClientModalProps) {
  const [formData, setFormData] = useState(edithistory);
...
export default EditSubscriptionHistoryModal;