...
interface EditBusinessTypeModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (updated: BusinessType ) => void;
  data: BusinessType;
}

function EditBusinessTypeModal({ isOpen, onClose, onSave, data }: EditBusinessTypeModalProps) {
  const [formData, setFormData] = useState<BusinessType>(data);
